# Mimi Moonbyte - ImageGen prompt set
Mode: OpenAI built-in ImageGen. Prompts below were grounded in the canonical character reference and generated layout guides.
...
Create one horizontal four-cardinal anchor strip for Codex pet `mimi-moonbyte`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `failed`.
...
Identity: same pet in every frame: Cute pretty quirky adult anime woman in compact chibi proportions, lilac bob hair, oversized navy beret with attached ivory crescent emblem, ivory high-collar long-sleeved tunic coat with navy trim, loose navy trousers and tiny ivory boots. Simple modest wholesome clothing, no sexy or mature themes. Friendly mischievous face, magical fantasy science fiction retro JRPG companion. No handheld props. Symmetric outfit.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `pixel`: Pixel-art-adjacent digital mascot with a chunky silhouette, simple dark outline, limited palette, flat cel shading, and visible stepped edges. User style notes: Crisp polished PC98 retro JRPG pixel art, limited lilac navy ivory and peach palette, expressive anime eyes, clean chunky clusters, simple readable silhouette.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `idle`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `jumping`.
...
Create one horizontal look-direction strip for Codex pet `mimi-moonbyte`, atlas row 10.
...
Create one horizontal look-direction strip for Codex pet `mimi-moonbyte`, atlas row 9.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `review`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `running-left`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `running-right`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `running`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `waiting`.
...
Create one horizontal animation strip for Codex pet `mimi-moonbyte`, state `waving`.
