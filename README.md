...
Three original custom companions, ready to copy between computers.
...
Each pet has nine standard animation states, sixteen clockwise look directions, and a transparent 1536×2288 v2 spritesheet. Both Neko characters retain a cigarette; Mild6's more covered design changes the clothing and colouring.
...
- [`mild6-neko/`](mild6-neko/), [`mild8-neko/`](mild8-neko/), [`mimi-moonbyte/`](mimi-moonbyte/): artwork, prompts, source strips, previews, and QA history.
